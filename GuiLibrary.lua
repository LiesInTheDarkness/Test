...
-- Fixed ChangeTheme function - fixed the unclosed parentheses
function RiseLib:ChangeTheme(themeName, window)
    ...
    -- If window is provided, update its theme
    if window and window.ThemeObjects then
        for element, instance in pairs(window.ThemeObjects) do
            if element == "Main" or element == "ThemeFrame" then
                instance.BackgroundColor3 = Themes[themeName].Background
            elseif element == "Topbar" or element == "CategoryContainer" then
                instance.BackgroundColor3 = Themes[themeName].LightContrast
            elseif element == "Shadow" or element == "Logo" or element == "RiseLogo" then
                instance.ImageColor3 = Themes[themeName].Accent
            elseif element == "ModuleContainer" then
                instance.ScrollBarImageColor3 = Themes[themeName].Accent
            elseif element == "Title" or element == "Version" or element == "ThemeButton" or element == "CloseButton" or element == "MinimizeButton" then
                instance.TextColor3 = Themes[themeName].TextColor
            end
        end
        
        -- Update mobile controls if they exist
        if isMobile and window.ThemeObjects.MobileMenuButton then
            window.ThemeObjects.MobileMenuButton.BackgroundColor3 = Themes[themeName].LightContrast
            window.ThemeObjects.MobileMenuButton.ImageColor3 = Themes[themeName].TextColor
            
            if window.ThemeObjects.MobileThemeButton then
                window.ThemeObjects.MobileThemeButton.BackgroundColor3 = Themes[themeName].LightContrast
                window.ThemeObjects.MobileThemeButton.ImageColor3 = Themes[themeName].Accent
            end
        end
        ...
        if window.Tabs then
            for _, tab in pairs(window.Tabs) do
                ...
                if tab == window.ActiveTab then
                    tab.Button.BackgroundColor3 = Themes[themeName].Accent
                else
                    tab.Button.BackgroundColor3 = Themes[themeName].LightContrast
                end
                
                -- Update tab icon and text
                tab.Button.TabIcon.ImageColor3 = Themes[themeName].TextColor
                tab.Button.TabName.TextColor3 = Themes[themeName].TextColor
                
                -- Update category frame
                tab.CategoryFrame.BackgroundColor3 = Themes[themeName].DarkContrast
                
                -- Update module frame
                tab.ModuleFrame.ScrollBarImageColor3 = Themes[themeName].Accent
                
                -- Update categories
                for _, category in pairs(tab.Categories) do
                    -- Update category buttons
                    local isActiveCategory = category.ModuleContainer.Visible
                    category.Button.TextColor3 = isActiveCategory and Themes[themeName].Accent or Themes[themeName].TextColor
                    
                    -- Update modules
                    for _, module in ipairs(category.Modules) do
                        if module.Type == "Toggle" then
                            module.Instance.BackgroundColor3 = Themes[themeName].LightContrast
                            module.Button.BackgroundColor3 = module.Value and Themes[themeName].Accent or Themes[themeName].DarkContrast
                            module.Circle.BackgroundColor3 = Themes[themeName].TextColor
                            module.Instance.ToggleName.TextColor3 = Themes[themeName].TextColor
                        elseif module.Type == "Slider" then
                            module.Instance.BackgroundColor3 = Themes[themeName].LightContrast
                            module.Instance.SliderContainer.BackgroundColor3 = Themes[themeName].DarkContrast
                            module.Fill.BackgroundColor3 = Themes[themeName].Accent
                            module.Instance.SliderName.TextColor3 = Themes[themeName].TextColor
                            module.Display.TextColor3 = Themes[themeName].TextColor
                        elseif module.Type == "Dropdown" then
                            module.Instance.BackgroundColor3 = Themes[themeName].LightContrast
                            module.Button.BackgroundColor3 = Themes[themeName].DarkContrast
                            module.Arrow.ImageColor3 = Themes[themeName].TextColor
                            module.Instance.DropdownName.TextColor3 = Themes[themeName].TextColor
                            module.Selection.TextColor3 = Themes[themeName].TextColor
                            module.Container.BackgroundColor3 = Themes[themeName].LightContrast
                            
                            for _, child in pairs(module.Container:GetChildren()) do
                                if child:IsA("TextButton") then
                                    child.TextColor3 = Themes[themeName].TextColor
                                end
                            end
                        elseif module.Type == "Button" then
                            module.Instance.BackgroundColor3 = Themes[themeName].LightContrast
                            module.Button.BackgroundColor3 = Themes[themeName].DarkContrast
                            module.Button.TextColor3 = Themes[themeName].TextColor
                        elseif module.Type == "Keybind" then
                            module.Instance.BackgroundColor3 = Themes[themeName].LightContrast
                            module.Button.BackgroundColor3 = Themes[themeName].DarkContrast
                            module.Button.TextColor3 = Themes[themeName].TextColor
                            module.Instance.KeybindName.TextColor3 = Themes[themeName].TextColor
                        elseif module.Type == "ColorPicker" then
                            module.Instance.BackgroundColor3 = Themes[themeName].LightContrast
                            module.Instance.ColorName.TextColor3 = Themes[themeName].TextColor
                            module.PickerFrame.BackgroundColor3 = Themes[themeName].LightContrast
                            module.CloseButton.BackgroundColor3 = Themes[themeName].Accent
                            module.CloseButton.TextColor3 = Themes[themeName].TextColor
                        elseif module.Type == "TextBox" then
                            module.Instance.BackgroundColor3 = Themes[themeName].LightContrast
                            module.Input.BackgroundColor3 = Themes[themeName].DarkContrast
                            module.Input.TextColor3 = Themes[themeName].TextColor
                            module.Instance.TextBoxName.TextColor3 = Themes[themeName].TextColor
                        elseif module.Type == "Label" then
                            module.Instance.BackgroundColor3 = Themes[themeName].LightContrast
                            module.TextLabel.TextColor3 = Themes[themeName].TextColor
                        end
                    end
                end
            end
    ...
    saveConfig({Theme = themeName}, "uisettings")
end
    ...
    local function themeSelector()
        ...
        for themeName, _ in pairs(Themes) do
            ...
            ThemeOption.MouseButton1Click:Connect(function()
                RiseLib:ChangeTheme(themeName, window)
                ThemePickerFrame.Visible = false
            end)
        end
